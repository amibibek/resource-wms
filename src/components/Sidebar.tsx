    ...
    items: [
      {
        ...
        icon: Database,
        subItems: [
          { label: "Customer", href: "/master/customers" }, // Changed from /customers
          { label: "Consignee", href: "/master/consignee" }, // Suggest changing others too
          { label: "Messages", href: "/master/messages" },
          { label: "Carrier", href: "/master/carrier" },
          { label: "Shipper", href: "/master/shipper" },
          { label: "Accessorials & Services", href: "/master/services" },
          { label: "Vendor Specific Price", href: "/master/pricing" },
          { label: "Location", href: "/master/location" },
          { label: "LOT", href: "/master/lot" },
          { label: "Notes", href: "/master/notes" },
        ],
      },
